...
// ! Certificate
qs(".certificate-popup").addEventListener("click", clickCertificatePopup);
function clickCertificatePopup(e) {
   if (
      e.target.closest(".certificate-popup__btn-close-wrap") ||
      e.target.closest(".certificate-popup__close-button") ||
      (!e.target.closest(".certificate-popup__container") && qs(".certificate-popup").classList.contains("active"))
   ) {
